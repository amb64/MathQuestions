...
{
    public class CompoundQuestion : Math, IPack // Essentially the same as the regular question but overrides the cardstodeal integer with 5 instead of 3. and will generate the string question with 5 instead of 3 cards
    {
